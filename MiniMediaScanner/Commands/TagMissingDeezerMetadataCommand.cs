...
public class TagMissingDeezerMetadataCommand : ICommand
{
    ...
    [CommandOption("confirm", 'y', 
        ...
        IsRequired = false,
        EnvironmentVariable = "TAGMISSINGDEEZERMETADATA_CONFIRM")]
    ...
    [CommandOption("overwrite-artist", 
        ...
        IsRequired = false,
        EnvironmentVariable = "TAGMISSINGDEEZERMETADATA_OVERWRITEARTIST")]
    ...
    [CommandOption("overwrite-album-artist", 
        ...
        IsRequired = false,
        EnvironmentVariable = "TAGMISSINGDEEZERMETADATA_OVERWRITEALBUMARTIST")]
    ...
    [CommandOption("overwrite-album", 
        ...
        IsRequired = false,
        EnvironmentVariable = "TAGMISSINGDEEZERMETADATA_OVERWRITEALBUM")]
    ...
    [CommandOption("overwrite-track", 
        ...
        IsRequired = false,
        EnvironmentVariable = "TAGMISSINGDEEZERMETADATA_OVERWRITETRACK")]
